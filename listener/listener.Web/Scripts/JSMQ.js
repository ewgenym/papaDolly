...
function LB() {
    ...
    this.terminated = function(endpoint) {
        ...
        if (that.writeDeactivated != null)
            that.writeDeactivated();
    };
...
JSMQ.Dealer = function() {
    ...
    lb.writeDeactivated = function() {
        if (that.deactivated_c != null) {
            that.deactivated_c(that);
        }
    }
